<template>
  <b-navbar toggleable fixed="top" :class="classes" >
...
export default {
  ...
  methods: {
    toggleMenu() {
      console.info('BaseNav->toggleMenu, this.show1=' +this.$props.show)
      /* this.$props.show = true */
      /* this.$emit('change', !this.show); */
      this.$emit('change', true);
    },
    closeMenu() {
      console.info('BaseNav->closeMenu, this.show1=' +this.show)
