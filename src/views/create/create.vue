  ...
  <div class="icontainer-subpage">
    <div class="">
      <div class="ipage-title">
        ...
        <div class="irequire ">
          <b-icon icon="asterisk" variant="danger" font-scale="0.6"></b-icon>
          <div class="icreate-desc">{{$t('page.requriedfields')}}</div>
        </div>
      </div>
      ...
      <div class="ifrom-group">
        <div class="ifrom-group-label">
          <div class="ilable color_yellow">{{$t('page.uploadFilesType')}}
        ...
        <div class="iinput-area icreate-upload-area">
          <el-upload action="#" accept="image/*,webgl/*,.glb,.gltf" list-type="picture-card" :auto-upload="false"
            :limit="1" :on-success="handleSuccess" :on-change="handlechange" ref="uploadfiles">
            ...
            <div slot="file" slot-scope="{file}">
              ...
              <template v-else-if="update_file_type=='video'">
                <video class="el-upload-list__item-thumbnail" :src="file.url" autoplay="autoplay"
                  controls="controls">Failed to generate thumbnail, but does not affect upload</video>
              </template>
              <template v-else-if="update_file_type=='audio'">
                <audio class="el-upload-list__item-thumbnail" :src="file.url" autoplay="autoplay"
                  controls="controls">Failed to generate thumbnail, but does not affect upload</audio>
              </template>
              <template v-else>
                <img class="el-upload-list__item-thumbnail" :src="file.url" alt="">
              </template>
      ...
      <div class="ifrom-group">
        <div class="ifrom-group-label">
          <div class="ilable color_yellow">{{$t('page.create_item_Name')}}
            <b-icon icon="asterisk" variant="danger" font-scale="0.4"></b-icon>
          </div>
          <!-- <b-icon icon="question-circle" class="iquestion-circle" variant="secondary" v-b-popover.hover.top="'Learn more about Sale in our Help Center'"></b-icon> -->
        </div>
        <div class="iinput-area">
          <div class="icreate-input-outer bg_lightgray">
            <input type="text" class="iinput iinput-create" v-model="form.names"
              :placeholder="$t('page.create_item_name_placeholder')" />
          </div>
        </div>
      </div>
      ...
      <div class="ifrom-group">
        ...
        <div class="iinput-area">
          <div class="icreate-input-outer bg_lightgray">
            <input type="text" class="iinput iinput-create" v-model="form.externallink"
      ...
      <div class="ifrom-group">
        ...
        <div class="iinput-area">
          <div class="icreate-input-outer bg_lightgray">
            <textarea v-model="form.descripton" :placeholder="$t('page.create_item_decription_placeholder')" rows="4"
              max-rows="8" class="iinput iinput-create itextarea"></textarea>
          </div>
        </div>
